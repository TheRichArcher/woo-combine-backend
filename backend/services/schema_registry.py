...
BASEBALL_DEFAULT = SportSchema(
    ...
    drills=[
        ...
        DrillDefinition(
            key="fielding_accuracy",
            label="Fielding Accuracy",
            unit="pts",
            lower_is_better=False,
            category="fielding",
            default_weight=0.15,
    ...
    presets=[
        PresetDefinition(
            ...
            weights={
                "sprint_60": 0.2,
                "exit_velocity": 0.2,
                "throwing_velocity": 0.2,
                "fielding_accuracy": 0.2,
                "pop_time": 0.2,
            },
        ),
        PresetDefinition(
    ...
    presets=[
        PresetDefinition(
            ...
            weights={
                "vertical_jump": 0.25,
                "approach_jump": 0.3,
                "serving_accuracy": 0.1,
                "passing_accuracy": 0.1,
                "attack_power": 0.2,
                "blocking_reach": 0.05,
            },
        )
