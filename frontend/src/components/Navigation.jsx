...
export default function Navigation() {
  ...
  return (
    <>
      {/* Minimal Tailwind test block for debugging */}
      <div className="sm:flex hidden bg-red-200 p-4">
        <a href="/dashboard" className="text-white font-bold">TEMP DASHBOARD LINK</a>
      </div>
