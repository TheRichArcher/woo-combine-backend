...
import { AGE_GROUP_SUGGESTIONS } from '../../constants/players';

/**
 * Modal component for editing player information
 * @param {Object} player - Player to edit
 * @param {Array} allPlayers - All players for age group suggestions
...
function EditPlayerModal({ player, allPlayers, onClose, onSave }) {
  ...
  // Extract existing age groups from all players for suggestions
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <datalist id="age-group-suggestions">
              {/* Existing age groups from current players */}
              {existingAgeGroups.map(ageGroup => (
                <option key={ageGroup} value={ageGroup} />
              ))}
              {/* Standard age group suggestions */}
              {AGE_GROUP_SUGGESTIONS.map(suggestion => (
