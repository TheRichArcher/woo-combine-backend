        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border-2 border-brand-primary/30">
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm rounded-lg font-semibold transition-colors ${hasChanges ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-200 text-gray-500'}`}
          ...
          {hasChanges && (
            <div className="mt-3">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-medium py-2 px-4 rounded-lg text-sm"
              >
