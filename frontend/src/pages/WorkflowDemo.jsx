...
export default function UnifiedDemo() {
  ...
  const renderStepContent = () => {
    ...
    switch (currentStep) {
      ...
      // CASE 3: Setup in 60 Seconds
      case 3:
        return (
          <div className="space-y-1">
            {/* Setup Process Demo */}
            <div className="bg-gradient-to-r from-green-500 to-teal-600 text-white rounded-lg p-2 text-center">
              <div className="text-2xl mb-1">🏃‍♂️</div>
              <h3 className="text-sm font-bold mb-1">Setup in 60 Seconds</h3>
              <p className="text-green-100 text-xs">Zero → running combine in 1 minute! ⚡</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-1">
              <div className="bg-green-50 border border-green-200 rounded p-1 text-center">
                ...
                <h4 className="font-bold text-green-800 text-xs">Name It</h4>
                <p className="text-green-700 text-xs">10 seconds</p>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded p-1 text-center">
                <div className="text-lg">📊</div>
                <h4 className="font-bold text-blue-800 text-xs">Upload CSV</h4>
                <p className="text-blue-700 text-xs">15 seconds</p>
              </div>
              <div className="bg-purple-50 border border-purple-200 rounded p-1 text-center">
                <div className="text-lg">🚀</div>
                <h4 className="font-bold text-purple-800 text-xs">Go Live!</h4>
                <p className="text-purple-700 text-xs">5 seconds</p>
              </div>
            </div>

            {/* Comparison */}
            <div className="grid grid-cols-2 gap-1">
              <div className="bg-red-900 text-white rounded p-1 text-center">
                <div className="text-xs font-bold text-red-200">Traditional: 45+ min</div>
              </div>
              <div className="bg-green-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold text-green-200">WooCombine: 30 sec</div>
              </div>
            </div>
          </div>
        );

      // CASE 4: Smart Parent Engagement
      case 4:
        return (
          <div className="space-y-1">
            {/* Parent Engagement Header */}
            <div className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-lg p-2 text-center">
              ...
              <p className="text-blue-100 text-xs">Parents connected live - no more waiting</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="bg-red-50 border border-red-200 rounded p-1">
                <div className="text-center mb-1">
                  ...
                  <h4 className="font-bold text-red-800 text-xs">Before</h4>
                </div>
                <div className="space-y-1 text-xs text-red-700">
                  <div>"How did my kid do?" ❌</div>
                  <div>"When will results be ready?" ❌</div>
                  <div>"What's his ranking?" ❌</div>
                  <div className="font-bold text-red-800">Frustrated parents</div>
                </div>
              </div>
              <div className="bg-green-50 border border-green-200 rounded p-1">
                <div className="text-center mb-1">
                  <span className="text-lg">😊</span>
                  <h4 className="font-bold text-green-800 text-xs">With WooCombine</h4>
                </div>
                <div className="space-y-1 text-xs text-green-700">
                  <div>✅ Instant recalc</div>
                  <div>✅ 99.8% accuracy</div>
            ...
            {/* Results */}
            <div className="bg-gradient-to-r from-blue-600 to-cyan-700 text-white rounded p-1">
              <div className="grid grid-cols-3 gap-1 text-center">
                <div className="bg-white/10 rounded p-1">
                  <div className="text-xs font-bold text-green-300">98%</div>
                  <div className="text-xs">Satisfaction</div>
                </div>
                <div className="bg-white/10 rounded p-1">
                  <div className="text-xs font-bold text-blue-300">Instant</div>
                  <div className="text-xs">Updates</div>
                </div>
                <div className="bg-white/10 rounded p-1">
                  <div className="text-xs font-bold text-purple-300">Zero</div>
        ...
        return (
          <div className="space-y-1">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg p-2 text-center">
              ...
              <p className="text-orange-100 text-xs">See how ridiculously easy it is to enter drill results</p>
            </div>

            {/* Demo Interface */}
            <div className="bg-white border-2 border-green-400 rounded-lg p-2">
              <div className="text-center mb-1">
                <div className="text-sm font-bold text-gray-800">🏃‍♂️ 40-Yard Dash Station</div>
              </div>
              
              <div className="grid grid-cols-2 gap-1 mb-1">
                <div className="text-center">
                  <div className="text-xs text-gray-600">Current Player</div>
                  <div className="bg-blue-100 rounded p-1">
                    <div className="text-sm font-bold text-blue-800">#12 Alex Johnson</div>
                    <div className="text-xs text-blue-600">U16 - Ready</div>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-gray-600">Enter Time</div>
              ...
              <div className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">✅ SAVE & NEXT PLAYER</div>
              </div>
            </div>

            {/* Speed Comparison */}
            <div className="grid grid-cols-3 gap-1">
              <div className="bg-orange-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">0.5s</div>
                <div className="text-xs">Entry</div>
              </div>
              <div className="bg-blue-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">Instant</div>
                <div className="text-xs">Parent</div>
              </div>
              <div className="bg-purple-600 text-white rounded p-1 text-center">
        ...
        return (
          <div className="space-y-1">
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg p-2 text-center">
              ...
              <p className="text-purple-100 text-xs">AI-powered adjustments in real-time</p>
            </div>

            {/* Weight Controls */}
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-2">
              <div className="text-center mb-1">
                <div className="text-sm font-bold text-gray-800">⚖️ Adjust Drill Weights</div>
              </div>
              
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-700">40-Yard Dash</span>
                  <div className="flex items-center gap-1">
                    <div className="w-12 h-1 bg-blue-500 rounded"></div>
                    <span className="text-xs font-bold text-blue-700">40%</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-700">Vertical Jump</span>
                  <div className="flex items-center gap-1">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-700">Agility</span>
                  <div className="flex items-center gap-1">
                    <div className="w-8 h-1 bg-orange-500 rounded"></div>
                    <span className="text-xs font-bold text-orange-700">30%</span>
                  </div>
                </div>
              </div>
              
              <div className="text-center mt-1">
                <div className="text-xs text-blue-600">📊 Rankings update instantly</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="bg-white border border-gray-200 rounded p-1">
                <div className="text-center mb-1">
                  <div className="text-xs font-bold text-gray-800">📊 Live Rankings</div>
                </div>
                <div className="space-y-1">
                  ...
                  <div className="flex justify-between text-xs">
                    <span>🥈 Alex</span>
                    <span className="font-bold text-gray-600">91.8</span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span>🥉 Riley</span>
              ...
              <div className="bg-green-50 border border-green-200 rounded p-1">
                <div className="text-center mb-1">
                  <div className="text-xs font-bold text-green-800">✨ The Magic</div>
                </div>
                <div className="space-y-1 text-xs text-green-700">
                  <div>✅ Instant recalc</div>
                  <div>✅ 99.8% accuracy</div>
      ...
      // CASE 7: Instant Professional Reports
      case 7:
        return (
          <div className="space-y-1">
            {/* Reports Header */}
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg p-2 text-center">
              ...
              <p className="text-indigo-100 text-xs">From raw data to scout-ready reports in 0.5 seconds</p>
            </div>

            {/* Report Preview */}
            <div className="bg-white border-2 border-purple-400 rounded-lg p-2">
              <div className="text-center mb-1">
                <div className="text-sm font-bold text-gray-800">📄 Spring Football League Results</div>
                <div className="text-xs text-gray-600">Generated in 0.5 seconds • Scout-ready</div>
              </div>
              
              <div className="grid grid-cols-2 gap-1 mb-1">
                <div>
                  <div className="text-xs font-bold text-purple-800">🏆 Top 3</div>
                  <div className="space-y-1">
                    <div className="flex justify-between text-xs">
                      <span>Morgan</span>
                      <span className="font-bold text-yellow-600">94.2</span>
                ...
                <div>
                  <div className="text-xs font-bold text-indigo-800">📈 Stats</div>
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between">
                      <span>Athletes:</span>
                      <span className="font-bold">24</span>
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">📧 EMAIL TO SCOUTS & PARENTS</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="bg-red-900 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">Manual: 4+ hours</div>
                <div className="text-xs text-red-200">Calculate, format, type</div>
              </div>
              <div className="bg-green-600 text-white rounded p-1 text-center">
                <div className="text-xs font-bold">WooCombine: 0.5s</div>
                <div className="text-xs text-green-200">One click → Pro PDF</div>
              </div>
            </div>
          </div>
